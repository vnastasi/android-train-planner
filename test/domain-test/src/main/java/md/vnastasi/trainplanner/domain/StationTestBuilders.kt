...
const val STATION_CODE = "8400380"
const val STATION_LONG_NAME = "Den Haag Laan v NOI"
const val STATION_MIDDLE_NAME = "DH Laan v NOI"
const val STATION_SHORT_NAME = "Laan v NOI"
const val STATION_SYNONYM_1 = "Laan van NOI"
const val STATION_SYNONYM_2 = "Laan van Nieuw Oost Indië"
const val COUNTRY_CODE = "NL"
const val LATITUDE = 52.0786094665527
const val LONGITUDE = 4.34277772903442

inline fun createStation(block: StationDsl.() -> Unit = {}) = StationDsl().apply(block).build()
